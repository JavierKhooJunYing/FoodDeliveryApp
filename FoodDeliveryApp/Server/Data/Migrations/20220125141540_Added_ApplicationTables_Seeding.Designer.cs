...
namespace FoodDeliveryApp.Server.Data.Migrations
{
    ...
    [Migration("20220125141540_Added_ApplicationTables_Seeding")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FoodDeliveryApp.Server.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("FoodDeliveryApp.Shared.Branch", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("FoodDeliveryApp.Shared.Customer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("FoodDeliveryApp.Shared.Delivery", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("FoodDeliveryApp.Shared.MenuItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("FoodDeliveryApp.Shared.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("FoodDeliveryApp.Shared.OrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("FoodDeliveryApp.Shared.Payment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("FoodDeliveryApp.Shared.Staff", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("FoodDeliveryApp.Shared.Delivery", b =>
                {
                    b.HasOne("FoodDeliveryApp.Shared.Customer", null)
                        .WithMany("Deliveries")
                        .HasForeignKey("CustomerId");

                    b.HasOne("FoodDeliveryApp.Shared.Order", "Order")
                        .WithMany()
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FoodDeliveryApp.Shared.Staff", null)
                        .WithMany("Deliveries")
            ...
            modelBuilder.Entity("FoodDeliveryApp.Shared.Order", b =>
                {
                    b.HasOne("FoodDeliveryApp.Shared.Branch", "Branch")
                        .WithMany()
                        .HasForeignKey("BranchId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FoodDeliveryApp.Shared.Customer", "Customer")
                        .WithMany("Orders")
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("FoodDeliveryApp.Shared.OrderItem", b =>
                {
                    b.HasOne("FoodDeliveryApp.Shared.MenuItem", "MenuItem")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("FoodDeliveryApp.Server.Models.ApplicationUser", null)
                        .WithMany()
