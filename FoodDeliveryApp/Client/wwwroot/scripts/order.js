...
function ready() {
    ...
    document.getElementsByClassName('button-purchase')[0].addEventListener('click', placeOrderClicked)
}
...
function addItemToCart(title, price, imageSrc) {
    ...
    var cartRowContents = `
                            ...
                            <div class = "cart-quantity cart-column">
                                ...
                                <button class = "button button-danger" type = "button">REMOVE ITEM</button>
                            </div>`
...
function updateCartTotal() {
    ...
    document.getElementsByClassName('cart-total-price')[0].innerText = 'S$' + total.toFixed(2)
}
